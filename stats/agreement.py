...
from data import data_pipeline, trim_valid_ministers
...
if __name__=="__main__":
    ...
    df = trim_valid_ministers(df, int(args.start))
    ...
    member_disagreement_count.to_csv(f'./data/member_disagreement_count_{start_year}.csv')
